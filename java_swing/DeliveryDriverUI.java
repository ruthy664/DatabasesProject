...
public class DeliveryDriverUI extends JFrame {
    ...
    String user = DatabaseLoginInfo.user; // Replace this with your database username
    String password = DatabaseLoginInfo.pass; // Replace this with your database password
