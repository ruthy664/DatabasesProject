...
(4, 1, 4, '2026-04-20', 4, 15),
(3, 3, 3, '2026-04-20', 2, 4),
(6, 5, 2, '2026-04-20', 5, 1),
(1, 2, 2, '2026-04-20', 2, 13),
(7, 2, 4, '2026-04-20', 3, 5),
(10, 5, 3, '2026-04-20', 5, 6),
(2, 1, 2, '2026-04-20', 4, 2),
(8, 4, 2, '2026-04-20', 4, 10),
(9, 4, 4, '2026-04-20', 3, 14),
(5, 5, 3, '2026-04-20', 2, 11);
...
(5, 'Pepperoni Pizza Slice', 4.00, TRUE),
(5, 'Cheese Pizza Slice', 3.75, TRUE),
(5, 'Garlic Knots', 5.25, FALSE),
(4, 'Vegan Wrap', 7.99, TRUE),
(4, 'Quinoa Salad', 8.49, TRUE),
(4, 'Veggie Bowl', 9.25, FALSE),
(2, 'Chicken Burrito', 10.99, TRUE),
(2, 'Beef Taco', 3.25, TRUE),
(2, 'Nachos', 6.75, FALSE),
(3, 'Kids Chicken Nuggets', 5.50, TRUE),
(3, 'Kids Mac & Cheese', 4.99, TRUE),
(2, 'Grilled Salmon', 14.99, TRUE),
(2, 'Steak Plate', 16.99, FALSE),
(6, 'Smoothie', 5.99, TRUE),
(6, 'Acai Bowl', 9.99, TRUE),
(7, 'Coffee', 2.50, TRUE),
...
(11, 'Stir Fry', 13.50, TRUE),
(12, 'Iced Tea', 2.25, TRUE),
(12, 'Lemonade', 2.50, FALSE),
(12, 'Espresso', 2.00, TRUE),
(13, 'Reuben', 8.00, TRUE),
(13, 'Sub', 10.00, TRUE),
(14, 'Espresso', 2.00, TRUE),
(14, 'Muffin', 3.00, TRUE),
(5, 'BBQ Chicken Pizza', 11.99, TRUE),
(16, 'Burger Combo', 12.99, TRUE),
(16, 'Onion Rings', 6.99, FALSE);
